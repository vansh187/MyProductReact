...
const Home = () => {
  ...
  const response = await fetch('https://my-product-backend-j1hu.onrender.com/v1/addFundsToWallet', {
      method: 'POST',
    ...
    handler: async function (response:any) {
      ...
      const verifyResponse = await fetch('https://my-product-backend-j1hu.onrender.com/v1/VerifyFundPayements', {
      method: 'POST',
      headers: { 
